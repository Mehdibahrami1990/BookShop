...
"[project]/src/utils/NumberSeperate.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function formatNumber(num) {
    ...
    return num === null || num === void 0 ? void 0 : num.toString().replace(regex, separator);
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$NumberSeperate$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/NumberSeperate.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
const CartItem = (param)=>{
    let { id, quantity } = param;
    _s();
    const [data, setData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartItem.useEffect": ()=>{
            ({
                "CartItem.useEffect": async ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("http://localhost:3001/products/".concat(id)).then({
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: [
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$NumberSeperate$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatNumber"])(data.price),
                                    " $"
                                ]
                            }, void 0, true, {
                                fileName: "[project]/src/components/CartItem.tsx",
...
const Cart = ()=>{
    _s();
    const { totalItems } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$ShoppingCartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useShoppingCartContext"])();
    const [data, setData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [disCountedPrice, setDisCountedPrice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Cart.useEffect": ()=>{
            ({
                "Cart.useEffect": async ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("http://localhost:3001/products").then({
    ...
    const totalPrice = totalItems.reduce((total, item)=>{
        ...
        return total + ((selectedProduct === null || selectedProduct === void 0 ? void 0 : selectedProduct.price) || 0) * item.quantity;
    }, 0);
    const handleSubmitDiscount = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("http://localhost:3001/discounts?code=".concat(discountCode)).then((result)=>{
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: [
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$NumberSeperate$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatNumber"])(totalPrice),
                                    "$"
                                ]
                            }, void 0, true, {
                                fileName: "[project]/src/app/cart/page.tsx",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: [
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$NumberSeperate$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatNumber"])(disCountedPrice),
                                    " $"
                                ]
                            }, void 0, true, {
                                fileName: "[project]/src/app/cart/page.tsx",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: [
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$NumberSeperate$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatNumber"])(finalPrice),
                                    " $"
                                ]
                            }, void 0, true, {
                                fileName: "[project]/src/app/cart/page.tsx",
...
_s(Cart, "D6gxVwS8L4nTglLXIZBp6Hk9v6A=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$ShoppingCartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useShoppingCartContext"]
    ];
});
...
//# sourceMappingURL=src_0f5b86f1._.js.map